...
# -*- coding: utf-8 -*-                                                            
#                                                                                  
# MCExperiment.py: A helper class implementing Monte Carlo
# simulations to generate frequency data for a supplied set
...
class MCExperiment():
    """ A wrapper class to hold Monte Carlo routines for 
        generation of measurement frequencies to feed into
        the neural network.
